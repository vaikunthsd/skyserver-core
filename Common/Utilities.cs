...
*/
        ...
        public double fmt(double num, int total, int digits)
        {
            double n = num;
            if (n == 0) return n;
        ...
        public string sname(double ra, double dec)
        {
            return "<span bgcolor='red'>" + hmsN(ra) + "&nbsp;&nbsp;" + dmsN(dec) + "</span>";
        }
        public string pad(double val)
        {
